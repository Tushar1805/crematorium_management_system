                      ...
                      child: Form(
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 10.0,),
                            TextField(
                              decoration: loginInputDecoration().copyWith(hintText: 'Gender'),
                            ),
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Text('Upload Proof Of Death' , style: whiteTextStyle().copyWith(fontSize: 14.0),)
                                    ],
                                  ),
                                ),
                              ),
                    ...
                    Spacer(),
                         FlatButton(
                           ...
                           child: Container(
                                ...
                                child: Center(child: Text('SUBMIT',style: whiteTextStyle().copyWith(fontSize: 15.0, fontWeight: FontWeight.w600),),),                            
                            ),
                         )   
                 ],
               ),
